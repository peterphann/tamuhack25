  ...
  return (
    <div className="mx-28 my-10 grid grid-cols-2">
      <div>
        {itinerary ? (
          <div>
            <p className={cn("text-6xl font-bold", afacad.className)}>
              Itinerary for {itinerary.city}
            </p>
            <p className="text-base font-light opacity-50">
              You have{" "}
              <span className="text-red">
                {itinerary?.events.length} activities
              </span>{" "}
        ...
        <div className="mr-0 mt-8 flex flex-col gap-6">
          {itinerary?.events.map((item, index) => (
            <div key={index}>
              ...
              <div className="flex items-center space-x-2">
                ...
                {item.location && (
                  ...
                  >
                    <RiMapPin2Fill className="h-5 w-5 opacity-30 transition-opacity hover:opacity-20" />
                  </div>
                )}
                {item.website && (
                  <a
                  ...
                  >
                    <RiExternalLinkFill className="h-5 w-5 opacity-30 transition-opacity hover:opacity-20" />
                  </a>
                )}
              </div>
        ...
        >
          ...
          <div>
            ...
            <div className="mb-2 mt-2 flex flex-wrap gap-2">
              <div className="flex w-fit items-center gap-2 rounded-2xl border bg-white px-2 py-1">
                <Checkbox
                  disabled={pageStatus === "loading"}
