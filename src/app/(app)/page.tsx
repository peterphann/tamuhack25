...
export default function Home() {
  ...
  return (
    ...
    <div className={"mx-28 mt-10"}>
      <motion.div initial={{opacity: 0, translateY: 20}} animate={{opacity: 1, translateY: 0}} transition={{duration: 3, delay: 1, type: "spring"}}>
        <h1 className={"text-6xl font-bold " + afacad.className}>
          Make delays more managable!
        </h1>
      </motion.div>

      <motion.div initial={{opacity: 0, translateY: 15}} animate={{opacity: 1, translateY: 0}} transition={{duration: 3, delay: 2, type: "spring"}}>
      ...
      <motion.div initial={{opacity: 0, translateY: 10}} animate={{opacity: 1, translateY: 0}} transition={{duration: 3, delay: 3, type: "spring"}}>
        {session
        ? <Link href={"/dashboard"}>
