...
export default function Home() {
  ...
  return (
    ...
    <div className={cn("flex flex-col mx-32 mt-80", afacad.className)}>
      <div className="flex justify-between items-center gap-x-12">
        <div className="flex flex-col gap-y-2">
          <h3 className="text-xl font-bold">Hotel Vouchers</h3>
          <h4 className="text-3xl font-bold">View and accept hotel vouchers</h4>
          <p className="w-2/3">Flock provides a convenient way to redeem vouchers from any delayed/cancelled flight and send the money to your bank account.</p>
        </div>

        <Image className="w-3/4 object-contain shadow-lg rounded-md" src={"/hotels.png"} alt="hotels" width="1920" height="1080" />
      </div>
    </div>
    </>
